...
func TestGetSupportedLogins(t *testing.T) {
	tests := []struct {
		name string
		want string
	}{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := GetSupportedLogins(); got != tt.want {
				t.Errorf("GetSupportedLogins() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestNewOptions(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := NewOptions(tt.args.usePersistentCache); !reflect.DeepEqual(got, tt.want) {
...
func TestOptions_UpdateFromEnv(t *testing.T) {
	tests := []struct {
		name string
		o    *Options
	}{
...
func TestOptions_GetCloudConfiguration(t *testing.T) {
	tests := []struct {
		name string
		o    *Options
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.o.GetCloudConfiguration(); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("Options.GetCloudConfiguration() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestOptions_ToString(t *testing.T) {
	tests := []struct {
		name string
		o    *Options
		want string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.o.ToString(); got != tt.want {
				t.Errorf("Options.ToString() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_getAuthenticationRecordFileName(t *testing.T) {
	type args struct {
		o *Options
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := getAuthenticationRecordFileName(tt.args.o); got != tt.want {
				t.Errorf("getAuthenticationRecordFileName() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_parsePoPClaims(t *testing.T) {
	type args struct {
		popClaims string
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := parsePoPClaims(tt.args.popClaims)
			if (err != nil) != tt.wantErr {
				t.Errorf("parsePoPClaims() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("parsePoPClaims() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestOptions_AddCompletions(t *testing.T) {
	type args struct {
		cmd *cobra.Command
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.o.AddCompletions(tt.args.cmd)
		})
	}
}

func TestOptions_GetPoPTokenCache(t *testing.T) {
	tests := []struct {
		name string
		o    *Options
		want *popcache.Cache
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.o.GetPoPTokenCache(); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("Options.GetPoPTokenCache() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestOptions_setPoPTokenCache(t *testing.T) {
	type args struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.o.setPoPTokenCache(tt.args.cache)
		})
	}
}
