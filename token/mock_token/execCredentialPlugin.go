...
// Source: github.com/Azure/kubelogin/pkg/token (interfaces: ExecCredentialPlugin)
...
func (m *MockExecCredentialPlugin) Do() error {
	m.ctrl.T.Helper()
...
func (mr *MockExecCredentialPluginMockRecorder) Do() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Do", reflect.TypeOf((*MockExecCredentialPlugin)(nil).Do))
}
